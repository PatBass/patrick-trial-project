...
namespace App\Tests\FunctionalTests\Front\LettreAttestationHonneur\Headless;
...
class RepriseDesDonnesEnTexteTest extends WebTestCase {
    ...
    /**
     * Method testRepriseDesDonnesEnTexte
     * @test
     */
    public function testRepriseDesDonnesEnTexte() {
        ...
        // assertText | xpath=(.//*[normalize-space(text()) and normalize-space(.)=concat('Attestation sur l', "'", 'honneur')])[3]/following::p[17] | [Prénom] [Nom]		
        $this->assertEquals("Prénom NOM", $this->webDriver->findElement(WebDriver\WebDriverBy::xpath("(.//*[normalize-space(text()) and normalize-space(.)=concat('Attestation sur l', \"'\", 'honneur')])[3]/following::p[17]"))->getText());		
